...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mamonca-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mamonca-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `mamonca` available on your platform:
...
```
pixi search mamonca --channel conda-forge
```
